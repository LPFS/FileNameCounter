...
{
    public class StringInstanceCounterSpanBasedSimplifiedTests
    {

        [Test]
         public void Should_throw_on_empty_target()
           => Assert.Throws<ArgumentException>(() => { new StringInstanceCounterSpanBasedSimplified(string.Empty, 16); });

        [Test]
        public async Task Should_handle_no_matches()
        {
            var counter = new StringInstanceCounterSpanBasedSimplified("aba", 8);
        ...
        {
            var counter = new StringInstanceCounterSpanBasedSimplified(target, 8);
        ...
        {
            var counter = new StringInstanceCounterSpanBasedSimplified("aba", 4);
         ...
         public async Task Load_test()
        {
            ...
            var counter = new StringInstanceCounterSpanBasedSimplified(target, sLength);
